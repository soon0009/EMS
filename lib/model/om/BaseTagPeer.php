...
abstract class BaseTagPeer {
	...
	const NORMALIZED_TAG = 'tag.NORMALIZED_TAG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Tag', 'NormalizedTag', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID, TagPeer::TAG, TagPeer::NORMALIZED_TAG, TagPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'tag', 'normalized_tag', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Tag' => 1, 'NormalizedTag' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID => 0, TagPeer::TAG => 1, TagPeer::NORMALIZED_TAG => 2, TagPeer::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'tag' => 1, 'normalized_tag' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::NORMALIZED_TAG);

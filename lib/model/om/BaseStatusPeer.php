...
abstract class BaseStatusPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (StatusPeer::ID, StatusPeer::STATUS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (StatusPeer::ID => 0, StatusPeer::STATUS => 1, ),
	...
	const COUNT = 'COUNT(status.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT status.ID)';

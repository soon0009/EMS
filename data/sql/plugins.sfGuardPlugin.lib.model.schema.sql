...
(
	...
	description TEXT,
	PRIMARY KEY (id),
	CONSTRAINT sf_guard_group_name_unique UNIQUE (name)
);
...
(
	...
	description TEXT,
	PRIMARY KEY (id),
	CONSTRAINT sf_guard_permission_name_unique UNIQUE (name)
);
...
(
	...
	PRIMARY KEY (id),
	CONSTRAINT sf_guard_user_username_unique UNIQUE (username)
);
